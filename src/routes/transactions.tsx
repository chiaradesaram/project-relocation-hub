...
const transactions: Tx[] = [
  ...
  { name: "Direct Invest CAL Growth Fund", product: "Unit Trusts", kind: "Investment", subAccount: "Personal · Main", date: "Apr 13, 2026", value: "LKR 125,000", positive: true, status: "Confirmed", fund: "Growth Opportunities Fund", units: 5208.33, unitPrice: "LKR 24.00", bankName: "Commercial Bank", bankAccount: "8001234521" },
  ...
  { name: "Cash In", product: "Treasuries", kind: "Cash In", subAccount: "Personal · Main", date: "Mar 20, 2026", value: "LKR 300,000", positive: true, status: "Confirmed", createdDate: "Mar 20, 2026 · 11:40", reflectedDate: "Mar 20, 2026", bankName: "Sampath Bank", bankAccount: "1100568832" },
  { name: "Cash Out", product: "Treasuries", kind: "Cash Out", subAccount: "Personal · Main", date: "Apr 19, 2026", value: "LKR 307,200", positive: false, status: "Pending", createdDate: "Apr 19, 2026 · 09:00", reflectedDate: "Apr 21, 2026", bankName: "Sampath Bank", bankAccount: "1100568832" },
  { name: "Redemption CAL Equity Fund", product: "Unit Trusts", kind: "Redemption", subAccount: "Personal · Main", date: "Apr 8, 2026", value: "LKR 75,000", positive: false, status: "Confirmed", fund: "Equity Fund", units: 2142.86, unitPrice: "LKR 35.00", bankName: "Sampath Bank", bankAccount: "1100568832" },
  ...
  { name: "Direct Invest CAL Balanced Fund", product: "Unit Trusts", kind: "Investment", subAccount: "Personal · Main", date: "Apr 1, 2026", value: "LKR 250,000", positive: true, status: "Confirmed", fund: "Balanced Fund", units: 8771.93, unitPrice: "LKR 28.50", bankName: "Sampath Bank", bankAccount: "1100568832" },
  { name: "Direct Invest CAL Money Market", product: "Unit Trusts", kind: "Investment", subAccount: "Corporate · Ops", date: "Mar 28, 2026", value: "LKR 200,000", positive: true, status: "Confirmed", fund: "Money Market Fund", units: 12987.01, unitPrice: "LKR 15.40", bankName: "Commercial Bank", bankAccount: "8001234521" },
  { name: "Fund Flip Growth Opportunities Fund", product: "Unit Trusts", kind: "Fund Flip", subAccount: "Personal · Main", date: "Apr 6, 2026", value: "LKR 80,000", positive: true, status: "Completed", fromFund: "Fixed Income Opportunities Fund", toFund: "Growth Opportunities Fund", createdDate: "Apr 6, 2026 · 10:12", redeemByDate: "Apr 8, 2026", reflectedDate: "Apr 9, 2026", units: 3333.33, unitPrice: "LKR 24.00", bankName: "Commercial Bank", bankAccount: "8001234521" },
  { name: "Fund Flip Money Market Fund", product: "Unit Trusts", kind: "Fund Flip", subAccount: "Corporate · Ops", date: "Mar 25, 2026", value: "LKR 120,000", positive: true, status: "Completed", fromFund: "Growth Opportunities Fund", toFund: "Money Market Fund", createdDate: "Mar 25, 2026 · 14:44", redeemByDate: "Mar 27, 2026", reflectedDate: "Mar 28, 2026", units: 7792.21, unitPrice: "LKR 15.40", bankName: "HNB", bankAccount: "0452201209" },
          ...
          {openTx?.kind !== "Cash In" && openTx?.kind !== "Cash Out" && (
            ...
            {openTx?.kind === "Pay In" || openTx?.kind === "Pay Out" ? (
              <div className="p-4">
                ...
                <p className="text-xs text-muted-foreground truncate">{openTx?.date}</p>
              </div>
            ) : (
              <>
